...
<div className="bg-purple-50 dark:bg-purple-900/30 rounded-lg p-6 my-6">
  <div className="font-semibold text-purple-800 dark:text-purple-200 mb-2">🔍 Importante sobre los hosts:</div>
  <ul className="text-purple-700 dark:text-purple-300 space-y-2">
    <li>• <strong>DATABASE_URL:</strong> Usa el Transaction Pooler <code>aws-X-region.pooler.supabase.com:6543</code></li>
    <li>• <strong>DB_POSTGRESDB_HOST:</strong> Usa el host directo <code>db.PROJECT_REF.supabase.com</code> con puerto <code>6543</code></li>
    <li>• <strong>Usuario:</strong> Simplemente <code>postgres</code> (no necesita el formato postgres.PROJECT_REF)</li>
  </ul>
</div>
...
- **N8N vs Zapier vs Make.com** - Comparación completa de plataformas de automatización
- **Mejores prácticas de N8N** - Optimización y patrones de diseño de workflows
- **Integrar N8N con APIs REST** - Guía de integración de servicios personalizados
- **Docker en Heroku** - Tutorial avanzado de contenedores
