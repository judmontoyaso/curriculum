  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="space-y-12">
        <CategorySection title="Fundamentos Espirituales" icon={faHeart}>
          <BookCard
            title="La Biblia"
        ...
        <CategorySection title="Estoicismo y Sabiduría Antigua" icon={faBrain}>
          <BookCard
            title="Meditaciones"
        ...
        <CategorySection title="Desarrollo Profesional y Tecnología" icon={faCode}>
          <BookCard
        ...
        <CategorySection title="Desarrollo Personal" icon={faLightbulb}>
          <BookCard
        ...
        <CategorySection title="Literatura" icon={faBook}>
          <BookCard
