...
const Navigation = () => {
  ...
  return (
    <div className="sticky top-0 z-20 py-2 bg-white md:py-6 md:mb-6 dark:bg-black  transition-color duration-1000">
      ...
      >
        <div className="lg:inline-flex lg:flex-row lg:ml-auto lg:mr-20 lg:w-auto w-full lg:items-center items-end  flex flex-col lg:h-auto  lg:sticky absolute dark:bg-black dark:bg-opacity-40 bg-white bg-opacity-40  transition-color duration-1000 ">
          <Link href="/">
